...
The Girls in Tech (GIT) Week is a 3-day virtual event organised by the Infocomm Media Development Authority (IMDA), as part of the SG Women in Tech initiative. The event aims to attract and interest tertiary students pursuing STEM (Science, Technology, Engineering and Medicine) and infocomm media-related subjects from the 5 local polytechnics in Singapore to learn more about the dynamic tech sector and the diversity of career opportunities it offers, and be further inspired to pursue a career in tech.

During 11-13 October 2021, students can interact and learn from female leaders from 17 participating tech companies through a series of discussions and games.

This event welcomes all tertiary students who are keen to pursue a career in tech. To register for the event, do click on the individual links for the each day below.
...
<table border="0" class="schedule-table">
	...
	<tr class="day-1">
		...
		<td>Salesforce</td>
		<td>Are you looking for a career in tech? Come and join Cecily, Area Vice President and General Manager of Salesforce Singapore, to learn how she embarks her career in tech and how you can do it too. Founded in 1999 in San Francisco, California, Salesforce has grown at a phenomenal rate to become the world’s fourth-largest software company. Salesforce is honored to be ranked on the FORTUNE “100 Best Companies To Work For®” list for the thirteenth year in a row. Salesforce creates and supports customer relationship management (CRM) software that helps break down the technology silos between departments to give companies a complete view of their customer everywhere they interact with your brand. If you aspire towards a career in Tech, we welcome you to come join us for the event and discover the endless opportunities in the industry that you can look forward to!</td>
	</tr>
	<tr class="day-1">
		<td>10.45-11.25am</td>
		<td>GovTech</td>
	...
	<tr class="day-1">
		<td>2.15pm-2.55pm</td>
		<td>Mastercard</td>
		<td>Mastercard is a global technology company in the payments industry. Our mission is to connect and power an inclusive, digital economy that benefits everyone, everywhere by making transactions safe, simple, smart and accessible. Beyond that, inclusion, opportunity and empowerment are global priorities at Mastercard. We strive for diversity of thought, background, experiences and abilities – creating an inclusive, level playing field where all people have equal opportunities to reach their full potential.<br/>Join us as we share with you how Singapore is poised to be the world’s first Smart Nation as you experience seamless digital experiences. Hear from some of our female colleagues about how they are supporting the future of digital payments.<br/>Bring your friends along for an informative yet fun-filled session!</td>
	</tr>
	<tr class="day-1">
		<td>3.00pm-3.40pm</td>
		<td>IBM</td>
	...
	<tr class="day-2">
		<td>10.00am - 10.40am</td>
		<td>PWC</td>
		<td>Pending synopsis</td>
	</tr>
	<tr class="day-2">
		<td>10.45-11.25am</td>
		<td>Poly slot #1 (students)</td>
	...
	<tr class="day-3">
		<td>2.15pm-2.55pm</td>
		<td>Unity</td>
		<td>Jo Hartanto - Talent Partner S.APAC<br/>&nbsp;&nbsp;&nbsp;&nbsp;Topic: Unity Story<br/>Sarah Foo - Campaign Marketing Associate, S.APAC<br/>&nbsp;&nbsp;&nbsp;&nbsp;Topic: Breaking into tech industry as student<br/>Su Wong - Inside Sales Representative, S.APAC<br/>&nbsp;&nbsp;&nbsp;&nbsp;Topic: Career as a journey of self-discovery</td>
	</tr>
	<tr class="day-3">
		<td>3.00pm-3.40pm</td>
		<td>NCS</td>
